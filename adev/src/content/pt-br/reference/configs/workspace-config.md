...
| `cli`            | Um conjunto de opções que personaliza o [Angular CLI](tools/cli). Veja [Opções de configuração do Angular CLI](#opções-de-configuração-do-angular-cli) abaixo.                                                               |
...
## Opções de configuração do Angular CLI
...
| `configurations` | Configurações alternativas para executar o target. Cada configuração define as opções padrão para aquele ambiente pretendido, sobrescrevendo o valor associado em `options`. Veja [Configurações de build alternativas](#configurações-de-build-alternativas) abaixo. |
...
### Configurações de build alternativas
...
| :------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `assets`                   | Um objeto contendo caminhos para assets estáticos a serem servidos com a aplicação. Os caminhos padrão apontam para o diretório `public` do projeto. Veja mais na seção [Configuração de assets](#configuração-de-assets).                                                                                 |
| `styles`                   | Um array de arquivos CSS a serem adicionados ao contexto global do projeto. O Angular CLI suporta imports CSS e todos os principais pré-processadores CSS. Veja mais na seção [Configuração de styles e scripts](#configuração-de-styles-e-scripts).                                                       |
| `stylePreprocessorOptions` | Um objeto contendo pares opção-valor para passar aos pré-processadores de estilo. Veja mais na seção [Configuração de styles e scripts](#configuração-de-styles-e-scripts).                                                                                                                                |
| `scripts`                  | Um objeto contendo arquivos JavaScript a serem adicionados à aplicação. Os scripts são carregados exatamente como se você os tivesse adicionado em uma tag `<script>` dentro do `index.html`. Veja mais na seção [Configuração de styles e scripts](#configuração-de-styles-e-scripts).                   |
...
| `index`                    | Um documento HTML base que carrega a aplicação. Veja mais em [Configuração de index](#configuração-de-index).                                                                                                                                                                                              |
