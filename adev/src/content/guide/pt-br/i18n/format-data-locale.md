<!-- ia-translate: true -->
# Formatar dados com base no locale

Angular fornece os seguintes [pipes](guide/templates/pipes) integrados de transformação de dados.
Os pipes de transformação de dados usam o token [`LOCALE_ID`][ApiCoreLocaleId] para formatar dados com base nas regras de cada locale.
...
## Use DatePipe para exibir a data atual
